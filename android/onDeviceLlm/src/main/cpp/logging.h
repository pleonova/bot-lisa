...
#ifndef ONDEVICELLM_LOGGING_H
#define ONDEVICELLM_LOGGING_H

#endif //ONDEVICELLM_LOGGING_H

#pragma once
#include <android/log.h>

#ifndef LOG_TAG
#define LOG_TAG "onDeviceLlm"
#endif
...
// Upstream calls __android_log_is_loggable() here to also respect Android's
// own per-tag runtime log level (adb setprop log.tag.<TAG> <LEVEL>). That
// function requires API 30+; this module builds for minSdk 24 (see
// ON_DEVICE_LLM_PLAN.md Phase 2 on why the module can't just match
// upstream's own minSdk 33). Losing that extra runtime filter is a minor
// debugging convenience, not a functional requirement -- LOG_MIN_LEVEL
// above still gates verbosity at compile time.
