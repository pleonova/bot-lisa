...
constexpr int   DEFAULT_CONTEXT_SIZE    = 2048;  // shrunk from upstream's 8192: our prompts are short single-turn, not multi-turn chat
...
Java_com_botlisa_llm_internal_InferenceEngineImpl_init(JNIEnv *env, jobject /*unused*/, jstring nativeLibDir) {
...
Java_com_botlisa_llm_internal_InferenceEngineImpl_systemInfo(JNIEnv *env, jobject /*unused*/) {
    return env->NewStringUTF(llama_print_system_info());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_botlisa_llm_internal_InferenceEngineImpl_benchModel(JNIEnv *env, jobject /*unused*/, jint pp, jint tg,
                                                      jint pl, jint nr) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_botlisa_llm_internal_InferenceEngineImpl_processSystemPrompt(
        JNIEnv *env,
        jobject /*unused*/,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_botlisa_llm_internal_InferenceEngineImpl_processUserPrompt(
        JNIEnv *env,
        jobject /*unused*/,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_botlisa_llm_internal_InferenceEngineImpl_generateNextToken(
        JNIEnv *env,
        jobject /*unused*/
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_botlisa_llm_internal_InferenceEngineImpl_unload(JNIEnv * /*unused*/, jobject /*unused*/) {
    // Reset long-term & short-term states
    reset_long_term_states();
    reset_short_term_states();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_botlisa_llm_internal_InferenceEngineImpl_shutdown(JNIEnv *, jobject /*unused*/) {
    llama_backend_free();
}
